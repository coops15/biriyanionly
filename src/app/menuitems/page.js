                ...
                {!display &&
                    <div className="w-96">
                        ...
                        <ol className="flex flex-col border relative">
                           {deletepermission && <div className="bg-white  border rounded-lg shadow-md shadow-gray-500 h-24 w-60 absolute left-20 top-1 p-6 flex flex-col gap-2 justify-center">
                                <div className="text-sm text-gray-900 items-center">
                                    Are yor sure want to DELETE this item?
                                </div>
                                <div className="flex flex-row justify-between">
                                    <button onClick={()=>setDeletePermission(false)} className="outline-0 text-sm bg-red-500 text-white px-2 py-1 rounded-lg">
                                        No
                                    </button>
                            ...
                            <li className="flex flex-row gap-5 p-1">
                                ...
                                <div className="flex gap-8 font-semibold text-sm items-center">
                                    ...
                                    <button className="outline-0" onClick={()=>setDeletePermission(true)}><Delete/></button>
                                </div>
